...
const Register = () => {
   ...
   const handleLogin=async (e)=>{
      ...
      try {
        ...
        const response=await axios.post('https://localhost:7274/api/Admin/register',login)
  ...
  <form method='POST'>
    ...
    <div className="register-link text-center mt-6 text-sm">
      <p>
        ...
        <Link to="/admin/login" className="text-blue-500 hover:underline font-semibold">Login</Link>
      </p>
    </div>
